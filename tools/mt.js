...
async function run(hc) {
    try {      
      ...
      mongoose.connection.db.dropCollection('orchestras', function(err, result) {
        if (err) console.log("No existing orchestras collection");
        if (result) console.log("Orchestras collection deleted");         
      });
      const hsw = new Orchestra( {        
        code: "HSW",
      ...
      //***************** SEASONS ************
      mongoose.connection.db.dropCollection('seasons', function(err, result) {
        if (err) console.log("No existing seasons collection");
        if (result) console.log("Seasons collection deleted");         
      });      
      let seasons = [];
      ...
      mongoose.connection.db.dropCollection('periods', function(err, result) {
        if (err) console.log("No existing periods collection");
        if (result) console.log("Periods collection deleted");         
      });
      let newFlPeriods = {};      
      ...
      mongoose.connection.db.dropCollection('weeks', function(err, result) {
        if (err) console.log("No existing weeks collection");
        if (result) console.log("Weeks collection deleted");         
      });      
      let weeks = [];   
      ...
      /*************** DPL *********** */
      mongoose.connection.db.dropCollection('dpls', function(err, result) {
        if (err) console.log("No existing dpls collection");
        if (result) console.log("Dpls collection deleted");         
      });    
      mongoose.connection.db.dropCollection('dplmetas', function(err, result) {
        if (err) console.log("No existing dplmetas collection");
        if (result) console.log("Dplmetas collection deleted");         
      });    
      mongoose.connection.db.dropCollection('dienst', function(err, result) {
        if (err) console.log("No existing dienst collection");
        if (result) console.log("Dienst collection deleted");         
      });        
      
      mongoose.connection.db.dropCollection('productions', function(err, result) {
        if (err) console.log("No existing productions collection");
        if (result) console.log("Productions collection deleted");                 
      });  
